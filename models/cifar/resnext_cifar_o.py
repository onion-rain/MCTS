...
__all__ = ['resnext', 'resnext29_8x64d_o', 'resnext29_16x64d_o']
...
def resnext29_8x64d_o(**kwargs):
    model = CifarResNeXt(cardinality=8, depth=29, widen_factor=4, **kwargs)
    return model

def resnext29_16x64d_o(**kwargs):
    model = CifarResNeXt(cardinality=16, depth=29, widen_factor=4, **kwargs)
    return model