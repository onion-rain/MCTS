...
>>>>>>> b980f3acbfbedeaef606f85a0fdce15ea50c7f9c
    ...
    def forward(self, x, stage_oup_scale_ids=None, mid_scale_ids=None):
        if stage_oup_scale_ids is None:
            stage_oup_scale_ids = [-1,]*20
            mid_scale_ids = [-1,]*20
...
def resnet50_meta_o(num_classes):
