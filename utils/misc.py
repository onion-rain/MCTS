...
__all__ = ['write_log', 'print_model_parameters', 'print_nonzeros', 'accuracy', 'get_path', 'AverageMeter']
...
def print_nonzeros(model):
    ...
    for name, param in model.named_parameters():
        ...
        total += total_count
        print(f'{name:10} | nonzeros = {nonzero_count:7} / {total_count:7} ({100 * nonzero_count / total_count:6.2f}%) | pruned = {total_count - nonzero_count :7} | shape = {array.shape}')
